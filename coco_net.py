...
#14 conv8   512  3 x 3 / 1    13 x  13 x 512   ->    13 x  13 x 512
w8 = weight_variable([3,3,1024,512])
b8 = bias_variable([512])
h8 = tf.nn.conv2d(o7, w8, strides=[1, 1, 1, 1], padding='SAME') + b8
o8 = leaky_relu(h8, relu_alpha)
n_params = n_params + 3*3*1024*512 + 512*4

#15 conv9   425  1 x 1 / 1    13 x  13 x 512   ->    13 x  13 x425
w9 = weight_variable([1,1,512,425])
b9 = bias_variable([425])
h9 = tf.nn.conv2d(o8, w9, strides=[1, 1, 1, 1], padding='SAME') + b9
# Linear output!
o9 = h9
n_params = n_params + 1*1*512*425 + 425 # There is not batch norm, so n_params is: kernel_size + n_biases
